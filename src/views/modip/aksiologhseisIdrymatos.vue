<template>
    <div>
        <CCard>
            <CCardHeader>
                <strong>Επιλογή τμήματος</strong>
            </CCardHeader>
            <CCardBody>
                <CSelect
                size="lg"
                ...
                horizontal
                :options="tmhmata"
                :value.sync="tmhma_select"
                >
                </CSelect>
            </CCardBody>
            <CCardFooter>
                <CButton @click="getMathhmataAnaTmhma(), collapse=true" color="primary" class="px-4" >Επιλογή τμήματος</CButton>
            </CCardFooter>
        </CCard>
...
export default  {
    ...
    methods: {
        ...
        getMathhmataAnaTmhma() {
            this.getErot();
            axios.post("http://localhost/restapi/api/modip/getMathhmataGiaSelect.php",{id:this.tmhma_select})
        ...
        getErot() {
            axios.post("http://localhost/restapi/api/Omea/getErotGiaSelect.php",{tmhma_id:this.tmhma_select})
