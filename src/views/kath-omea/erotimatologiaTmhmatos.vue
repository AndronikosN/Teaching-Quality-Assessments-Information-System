...
<div>
    <div v-for="entry in erotimatologia" :key="entry.id">
        ...
        <CCard>
            ...
            <CCardFooter>
                <CButton @click="getQnAForModip(entry.id), myModal = true" color="primary" variant="" size="sm">Εμφάνιση ερωτήσεων</CButton>
            </CCardFooter>
        </CCard>
        </div>
...
export default {
    ...
    methods: {
        ...
        getErotimatologiaAnaTmhma() {
            axios.post("http://localhost/restapi/api/modip/getErotimatologiaAnaTmhma.php",{tmhma_id:this.tmhma_id})
    ...
    mounted(){
        ...
        this.getErotimatologiaAnaTmhma();
